...
class ApiProductRoute {
    ...
    fun showHomePage(): RestResponse {
        ...
        advers.add(Advert("ad_1", "轮播图", "www.baidu.com", "https://joyspace1.uni-colour.com/doc/home_page/1.png"))
        advers.add(Advert("ad_2", "轮播图", "www.baidu.com", "https://joyspace1.uni-colour.com/doc/home_page/2.png"))
        advers.add(Advert("ad_3", "轮播图", "www.baidu.com", "https://joyspace1.uni-colour.com/doc/home_page/3.png"))
        advers.add(Advert("ad_4", "轮播图", "www.baidu.com", "https://joyspace1.uni-colour.com/doc/home_page/4.png"))
