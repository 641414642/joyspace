...
interface PrintStationService {
    ...
    fun createPrintStation(baseUrl: String, password: String, positionId: Int, printerType:String, adSetId: Int, selectedProductIds: Set<Int>): PrintStation?
    fun updatePrintStation(id: Int, baseUrl: String, password: String, positionId: Int, printerType:String, adSetId: Int, selectedProductIds: Set<Int>): Boolean
