...
interface PrintOrderService {
    ...
    //上传单张合成订单图片
    fun uploadOrderImage(filterImageId: String,sessionId: String, orderItemId: Int,name: String, imgFile: MultipartFile?, x: Double, y: Double, scale: Double, rotate: Double): Boolean
