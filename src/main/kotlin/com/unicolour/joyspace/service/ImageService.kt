...
interface ImageService {
    ...
    fun transformImage(sessionId: String, imageId: Int, imageRatio:Double, initialRotate: Int, translateX: Int, translateY: Int, scale: Double, rotate: Double, baseUrl: String): ImageInfo?
